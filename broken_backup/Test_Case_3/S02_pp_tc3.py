...
# ymax
# step 1: identify maximum y value from pathline file


pathline = os.path.join('workspace','test_case_3.mppth')

# step 1a: define the well location

well_x = 53350 + 25
well_y = 19950 + 25


# pull the max and min y values from the pathline file
...
# step 2: calculate difference between xstag and mmmaxx
